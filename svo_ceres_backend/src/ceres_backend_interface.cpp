    ...
    const FrameBundlePtr& new_frame_bundle)
{
  ...
  ImuMeasurements imu_measurements;
  const double current_frame_bundle_stamp =
      new_frame_bundle->getMinTimestampSeconds();
  ...
  {
    {
      ...
      VLOG(1) << "Map containes " << nResiduals << " residuals:";
      VLOG(1) << " - nHomogeneousPointError " << nHomogeneousPointError;
      VLOG(1) << " - nReprojectionError " << nReprojectionError;
      VLOG(1) << " - nSpeedAndBiasError " << nSpeedAndBiasError;
      VLOG(1) << " - nMarginalizationError " << nMarginalizationError;
      VLOG(1) << " - nPoseError " << nPoseError;
      VLOG(1) << " - nIMUError " << nIMUError;
